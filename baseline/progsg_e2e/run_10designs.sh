...
# ---------------------------------------------------------------------------
# Quick launcher for ProgSG multimodal training on the ForgeHLS 10-design set.
#
# Usage:
#   ./run_10designs.sh [extra-python-args]
# ---------------------------------------------------------------------------
...
OUTPUT_DIR="${PROJECT_ROOT}/progsg_runs/forgehls_10designs"
